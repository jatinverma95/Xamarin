...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HelloWorld.Droid.FlatButtonRenderer, HelloWorld.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", FlatButtonRenderer.class, __md_methods);
	}
	...
	public FlatButtonRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == FlatButtonRenderer.class)
			mono.android.TypeManager.Activate ("HelloWorld.Droid.FlatButtonRenderer, HelloWorld.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
